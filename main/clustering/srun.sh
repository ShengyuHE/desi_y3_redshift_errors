...
run_srun() {
    case $1 in
        cat)
            srun -N 1 -n 1 -c 128 -C cpu -t 04:00:00 --qos interactive --account desi python build_catalogs.py --version AbacusHF-v2 --zerrs verr_empirical --domain cubic --tracer QSO
