...
Copy saved holi-v3 QSO, LRG, and ELG mesh2 NGC/SGC measurements into
    ...
    for tracer in ELG; do
        ...
        for zbin in "${redshift_bins[@]}"; do
            for region in NGC SGC; do
                source_file="$source_dir/mesh2_spectrum_poles_${source_tracer}_${zbin}_${region}_weight-default-FKP.h5"
                dest_file="$dest_dir/mesh2_spectrum_poles_${tracer}_${zbin}_${region}_holi_v3.h5"
